...
const ReusablePriorityPage = ({ priority }: Props) => {
     ...
     if (!tasks || isError) return <div>Error ferching tasks...</div>
     ...
     return (
          <div className='m-5 p-4'>
               ...
               <Header
                    name='Priority Page'
                    buttonComponent={
                         <button className='mr-3 rounded bg-blue-500 p-4 py-2 font-bold text-white hover:bg-blue-800' onClick={() => setIsModalNewTaskOpen(true)}>
                              Add New Task
                         </button>
                    }
               />
