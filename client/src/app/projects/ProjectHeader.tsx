...
import { Clock, FilterIcon, Grid3x3, Grid3X3, List, PlusSquareIcon, Share2, Table } from 'lucide-react'
               ...
               <div className='flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center'>
                    ...
                    <div className='flex items-center gap-2'>
                         ...
                         <div className='relative'>
                              <input type='text' placeholder='Search' className='rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-x-dark-secondary dark:bg-dark-secondary dark:text-white' />
