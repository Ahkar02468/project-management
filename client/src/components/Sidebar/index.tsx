...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, BriefcaseIcon, ChevronDown, ChevronUp, Home, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
          ...
          <div className={sidebarClassNames}>
               <div className='flex h-[100%] w-full flex-col justify-start'>
                    ...
                    <div className='flex item-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700 '>
                         <Image src='https://pm-sc-images.s3.us-east-1.amazonaws.com/logo1.png' alt='logo' width={40} height={40} />
                         <div>
...
const SidebarLink = ({
     ...
     return (
          <Link href={href} className='w-full'>
               <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${isActive ? "bg-gray-100 dark:bg-gray-700" : ""} justify-start px-8 py-3`}>
                    {isActive && (
